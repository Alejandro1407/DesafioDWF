      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-lg-6 col-md-6 mb-4">
          ...
          <div class="card">
            ...
            <!-- Card header -->
            <div class="card-header text-center">Gestión de Ofertas</div>
			<h5 class="text-center grey-text mt-3 mr-auto ml-auto d-block w-50">Registrar nuevas ofertas, así como ver las ofertas existentes categorizadas </h5>
            <!--Card content-->
            <div class="card-body text-center">
                <a href="/DesafioMVC/Empresa/Ofertas" class="btn btn-black"><i class="fas fa-percent mr-3"></i>Gestionar Empresas</a>
            </div>
          </div>
          <!--/.Card-->
        </div>
        ...
        <div class="col-lg-6 col-md-6 mb-4">
          ...
          <div class="card">
            ...
            <!-- Card header -->
            <div class="card-header text-center">Gestión de Dependientes</div>
				<h5 class="text-center grey-text mt-3 mr-auto ml-auto d-block w-50">Registro, actualización y eliminación de dependientes de sucursal.</h5>
            <!--Card content-->
            <div class="card-body text-center">
                <a href="/DesafioMVC/Empresa/Dependientes" class="btn btn-cyan"><i class="fas fa-user-cog mr-3"></i>Gestionar Rubros</a>
            </div>
